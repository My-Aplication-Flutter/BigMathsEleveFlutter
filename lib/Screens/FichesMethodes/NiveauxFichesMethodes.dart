...
import "ListThemesFichesMethodes.dart";
...
/// PAGE
/// =====================
class MenuSectionFicheMethodePage extends StatefulWidget {
  ...
  @override
  State<MenuSectionFicheMethodePage> createState() => _MenuSectionPageState();
}

class _MenuSectionPageState extends State<MenuSectionFicheMethodePage> {
    ...
    return GestureDetector(
      onTap: () {
        ...
        Navigator.push(
          context,
          MaterialPageRoute(
            builder: (context) => ThemesPage(niveauId: section.niveauId),
          ),
        );
      },
      child: Container(
