...
class SousTheme {
  ...
  final List<FicheCours> fichesCours;

  SousTheme({
    required this.id,
    required this.nom,
    required this.fichesCours,
  });
  ...
  factory SousTheme.fromJson(Map<String, dynamic> json) {
    return SousTheme(
      id: json['_id'] ?? "",
      nom: json['nom'] ?? "",
      fichesCours: (json['fiches_cours'] as List?)
              ?.map((e) => FicheCours.fromJson(e))
              .toList() ??
          [],
    );
  }
...
/// PAGE
/// ==========================================
class SousThemesCoursPage extends StatefulWidget {
  final String themeId;
  final String themeName;

  const SousThemesCoursPage({
    super.key,
  ...
  @override
  State<SousThemesCoursPage> createState() => _SousThemesCoursPageState();
}

class _SousThemesCoursPageState extends State<SousThemesCoursPage> {
      ...
      if (data['state'] == true) {
        ...
        setState(() {
          sousThemes = list
              ...
              /// 🔥 GARDE UNIQUEMENT
              /// LES SOUS THEMES AVEC FICHES
              .where(
                (s) => s.fichesCours.isNotEmpty,
              )
              .toList();
        });
      } else {
        ...
        children: [
          ...
          Padding(
            ...
            child: Container(
              ...
              child: Text(
                "${sousTheme.fichesCours.length} fiche(s) méthode",
                style: TextStyle(
          ...
          /// IMAGES
          Column(
            children: sousTheme.fichesCours.map((fiche) {
              return Padding(
